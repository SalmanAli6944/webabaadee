...
export class AddpropertyService {
    ...
    async addproperty(addpropertydto: Addpropertydto,user:User,images:Addimagedto[]) {
        ...
        addproperty.propertytitle = propertytitle;
        //console.log(propertytitle);
        addproperty.propertydescription = propertydescription;
        //console.log(propertydescription);
        addproperty.landarea = landarea;
        ...
        addproperty.areaunitid = findareaunit;
